...
import questionSetRoutes from './question-set.routes.js';
import setAttemptRoutes from './set-attempt.routes.js';
...
async function v1Routes(v1) {
  ...
  v1.register(examRoutes);
  v1.register(questionSetRoutes);
  v1.register(setAttemptRoutes);
  ...
  v1.register(internalAdminRoutes);
